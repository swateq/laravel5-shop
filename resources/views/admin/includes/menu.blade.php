...
<head>
  ...
  <link rel="stylesheet" href="/laravel5-learning/public/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  <link rel="stylesheet" href="/laravel5-learning/public/css/app.css">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li
          ...
          class="active"
        @endif
        ><a href="{{ url('/products') }}"><i class="fa fa-link"></i> <span>Produkty</span></a></li>
        <li
        @if (Route::current()->getName()=='users')
          class="active"
        @endif
        ><a href="{{ url('/users') }}"><i class="fa fa-users"></i> <span>Użytkownicy</span></a></li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
            <a href="#"><i class="fa fa-pencil-square-o"></i> Podstrony
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                ...
                <li><a href="/laravel5-learning/public/admin/page/{{$podstrona->id}}"><i class="fa fa-{{$podstrona->icon_name}}"></i> {{$podstrona->name}}</a></li>
                @endforeach
              </ul>
            </li>
          </ul>
...
<script src="/laravel5-learning/public/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- CK Editor -->
